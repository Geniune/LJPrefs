...
- (void)setStatus:(NSString *)string {
    ...
    CGFloat stringWidth = 100;
    CGFloat stringHeight = 20;
    CGRect labelRect = CGRectZero;
    
    if(string) {
//        CGSize stringSize =[AppGlobarManager sizeText:string font:self.stringLabel.font constrainedToSize:CGSizeMake(200, 300)];
        //[string sizeWithFont:self.stringLabel.font constrainedToSize:CGSizeMake(200, 300)];
